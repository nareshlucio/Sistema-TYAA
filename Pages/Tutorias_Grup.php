<?php 
 ...
 $sql = "SELECT * FROM tutoria_grupal LIMIT :inicio,:tutxpag";
 ...
 #-----------------------Final de Conteo--------------------------
 if (!$_GET) {
    header('Location:Tutorias_Grup.php?pagina=1');
  }
...
<head>
  ...
  <title>Registro de Tutorias Grupales</title>
  <!-- Favicon -->
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              <h1 class="text-white">Registrar Tutoria Grupal</h1>
    ...
    <div class="row justify-content-center">
      <div class="col-lg-6 col-md-8">
        ...
        <!-- Button trigger modal -->
          <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Registrar Tutoria Grupal</button>
          <!-- Modal -->
                          ...
                          <form role="form">
                            ...
                            <div class="form-group">
                              <div class="input-group input-group-alternative mb-3">
                                ...
                                <input class="form-control" placeholder="Motivo de la Tutoria" type="email">
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="input-group input-group-alternative">
                                ...
                                <input class="form-control" placeholder="Grupo" type="text">
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="input-group input-group-alternative mb-3">
        ...
        <table class="table align-items-center table-flush">
          <thead class="thead-light">
            <tr>
              ...
              <th scope="col">Matricula del Jefe de Grupo</th>
            ...
            <tbody>
              <?php foreach ($res as $tutorias): ?>                  
                ...
                <td>
                  <?php echo $tutorias['Motivo_Grupo'] ?>
                </td>
                <td>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
              ...
              <li class="page-item <?php echo $_GET['pagina']<=1 ? 'disabled': '' ?>">
                <a class="page-link" href="Tutorias_Grup.php?pagina=<?php echo $_GET['pagina']-1?>">
              ...
              <?php for($i=0;$i<$pag;$i++): ?>
                ...
                <li class="page-item <?php echo $_GET['pagina']==$i+1 ? 'active' : '' ?>">
                  <a class="page-link" href="Tutorias_Grup.php?pagina=<?php echo $i+1; ?>">
                  <?php echo $i+1 ?>
                  </a>
                </li>
